...
if convex 
    [X_RALMPC,U_RALMPC,S_RALMPC,J_RALMPC,X_hat_OL_RALMPC,X_bar_OL_RALMPC,V_OL_RALMPC,S_OL_RALMPC,J_wc_RALMPC,time_RALMPC,Theta_HC_t_RALMPC]=RALMPC_Convex_Online(x0,SS,Q_func,A_0,A_1,A_2,B_0,B_1,B_2,A_star,B_star,H_w,h_w,W_V,Q,R,K,F,G,d_bar,L_B,c,H,B_p,n,m,N_RALMPC,p,Theta_HC0,theta_bar0,eta_0,rho_theta0,Delta,mu,T_s,numberitertions,adpation,disturbance_deter);
else
    [X_RALMPC,U_RALMPC,S_RALMPC,J_RALMPC,X_hat_OL_RALMPC,X_bar_OL_RALMPC,V_OL_RALMPC,S_OL_RALMPC,J_wc_RALMPC,time_RALMPC,Theta_HC_t_RALMPC]=RALMPC_Online(x0,SS,Q_func,A_0,A_1,A_2,B_0,B_1,B_2,A_star,B_star,H_w,h_w,W_V,Q,R,K,F,G,d_bar,L_B,c_max,c,H,B_p,n,m,N_RALMPC,p,Theta_HC0,theta_bar0,eta_0,rho_theta0,Delta,mu,T_s,numberitertions,disturbance_deter);
end
...
save(name,"S_inital","X_bar_inital","X_hat_OL_RMPC","X_bar_OL_RMPC","V_OL_RMPC","S_OL_RMPC","J_RMPC","X_RMPC","U_RMPC","time_RMPC","Theta_HC_t_RMPC","X_hat_OL_RAMPC","X_bar_OL_RAMPC","V_OL_RAMPC","S_OL_RAMPC","J_RAMPC","X_RAMPC","U_RAMPC","time_RAMPC","Theta_HC_t_RAMPC","X_RALMPC","U_RALMPC","S_RALMPC","J_RALMPC","X_hat_OL_RALMPC","X_bar_OL_RALMPC","V_OL_RALMPC","S_OL_RALMPC","J_wc_RALMPC","time_RALMPC","Theta_HC_t_RALMPC","X_OL_OS","V_OL_OS","J_OS","X_OS","U_OS","time_OS","X_RLMPC","U_RLMPC","S_RLMPC","J_RLMPC","X_hat_OL_RLMPC","X_bar_OL_RLMPC","V_OL_RLMPC","S_OL_RLMPC","J_wc_RLMPC","time_RLMPC","Theta_HC_t_RLMPC","H")
