...
name1="/Users/hannes/Documents/MATLAB/Master_Thesis/RALMPC_LTI_Query/Plots/Figure1_"+"Iter"+string(iteration)+"_N"+string(N)+"Disturbance"+string(disturbance)+".png";
saveas(gcf,name1)
% %% Figure 2
% figure(2)
% for k=1:length(X_bar_inital)
...
ylabel("\theta_2")
title("Parameter set")
name2="/Users/hannes/Documents/MATLAB/Master_Thesis/RALMPC_LTI_Query/Plots/Figure2_"+"Iter"+string(iteration)+"_N"+string(N)+"Disturbance"+string(disturbance)+".png";
saveas(gcf,name2)
%% Figure 4
figure(4);
x1=["RMPC","RAMPC"];
...
grid on
ylim([7.5;12])
name3="/Users/hannes/Documents/MATLAB/Master_Thesis/RALMPC_LTI_Query/Plots/Figure3_"+"Iter"+string(iteration)+"_N"+string(N)+"Disturbance"+string(disturbance)+".png";
saveas(gcf,name3)
end